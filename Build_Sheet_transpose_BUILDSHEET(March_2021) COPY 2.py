...
def data_out(final_df, high_touch, batch=''):
    ...
    outfile = 'C:/Users/xcxg109/NonDriveFiles/Audit_Buildsheet COPY_'+str(batch)+'.xlsx'  
...
#        main_df.to_csv('C:/Users/xcxg109/NonDriveFiles/post.csv')
...
# if original df < 900K rows, process the entire thing at once
else:
