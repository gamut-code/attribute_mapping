...
#generate the file name used by the various output functions
    if search_level == 'SKU':
        ...
        if quer == 'original flavor GRAINGER-GAMUT':
...
def attribute_match_data_out(directory_name, df, search_level):
    ...
    quer = 'original flavor GRAINGER-GAMUT'
    ...
    columnsTitles = ['Gamut/Grainger SKU Counts', 'Grainger Blue Path', 'Segment_ID', 'Segment_Name', \
                     ...
                     'Gamut_Attr_ID', 'Gamut_Attribute_Name', 'Matching', 'ENDECA_RANKING', 'Gamut_MERCH_Usage', \
                     'Grainger_Attribute_Definition', 'Grainger_Category_Specific_Definition', \
                     'Gamut_Attribute_Definition', 'alt_grainger_name', 'alt_gamut_name']
