...
class PostgresDatabase_toolbox:
    ...
    def _connect2postgres_(self, db):
        ...
        host = "internal-a2f28bfa4a66111ea879b0eb1772950c-497179608.us-east-1.elb.amazonaws.com"
        port = 5432
    ...
    def _getcreds_():
        ...
        username = parser.get("POSTGRES_TOOLBOX", "USER")
        password = parser.get("POSTGRES_TOOLBOX", "PASS")
