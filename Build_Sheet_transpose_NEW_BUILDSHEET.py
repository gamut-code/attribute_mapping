...
def data_out(final_df, high_touch, batch=''):
    ...
    if high_touch.empty == False:
        ...
        if not def_col:
            high_touch = high_touch[['Taxonomy Node', 'Attribute Name', 'Sample Values', 'High Touch']]    
        else:
            high_touch = high_touch[['Taxonomy Node', 'Attribute Name', def_col[0], 'Sample Values', 'High Touch']]    
