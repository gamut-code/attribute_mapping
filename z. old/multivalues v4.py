    ...
    if search_level == 'single':
        ...
        for node in search_data:
            ...
            if init_ws_df.empty == False:
                ...
                if len(node_ids)>100:
                    num_lists = round(len(node_ids)/100, 0)
                    ...
                    for k in range(0, len(div_list)):
                        ...
                        if att_vals.empty==False:            
#                            ws_df.to_csv('C:/Users/xcxg109/NonDriveFiles/test_ws.csv')
#                            att_vals.to_csv('C:/Users/xcxg109/NonDriveFiles/test_atts.csv')
                            ws_df = pd.merge(ws_df, att_vals, on=['WS_Node_Name', 'WS_SKU', 'WS_Attribute_Name'])
                    ...
                    for n in node_ids:
                        ...
                        single_df = gws.gws_q(gws_values_single, 'tprod."categoryId"', n)
